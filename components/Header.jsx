...
export const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 flex items-center h-20 sm:h-16 z-10 border drop-shadow-md bg-white">
      <div className="flex flex-col sm:flex-row sm:justify-between h-full w-11/12 sm:10/12 md:w-9/12 lg:w-8/12 xl:px-48 2xl:px-60 mx-auto">
        <Link href="/">
        ...
        <nav className="flex justify-between w-40 sm:w-52 h-full">
          {routesList.map((item) => {
